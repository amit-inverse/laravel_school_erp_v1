        ...
        <tbody>
            ...
            <tr>
                ...
                <td width="120">
                    ...
                    <div class='btn-group'>
                        <a href="{{ route('classAssignings.show', [$classAssignings->id]) }}" class='btn btn-default btn-xs'>
                            <i class="far fa-eye"></i>
                        </a>
                        <a href="{{ route('classAssignings.edit', [$classAssignings->id]) }}" class='btn btn-default btn-xs'>
